...
$ qemu-system-x86_64                                                              \
    -M q35,accel=tcg,kernel-irqchip=split -m 4G -smp 4 -enable-kvm                \
    ...
    -kernel ~/cosim/Downloads/ubuntu-20.04-server-cloudimg-amd64-vmlinuz-generic        \
    -append "root=/dev/sda1 ro console=tty1 console=ttyS0 intel_iommu=on"         \
    -initrd ~/cosim/Downloads/ubuntu-20.04-server-cloudimg-amd64-initrd-generic
```
